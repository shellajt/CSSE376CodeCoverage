...
{	
	...
	@Test
	public void TestDoubleMilesShorterThan5000(){
	...
	@Test
	public void TestDiscountWhereReductionPercent0(){
	...
	@Test
	public void TestDiscountWhereFrequentFlierMilesGreaterThanUsers(){
		Discount target = new Discount(0.01, 100000000);
		ServiceLocator.Instance().AddDiscount(target);
		this.target.book(new Booking[]{new Flight(StartDate, EndDate, 100), new Hotel(5), new Car(3)});
		assertEquals(1035.0, this.target.Price(), 0.01);
	}
